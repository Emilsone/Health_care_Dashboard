<template>
  ...
  <div
    class="w-1/2 md:w-1/3 lg:w-32 fixed md:top-0 md:left-0 h-screen lg:block bg-gray-100 border-r z-30"
  ...
  >
    ...
    <div class="mb-4 px-4">
     <p class="font-semibold text-3xl text-blue-400 pl-0">LOGO</p>
      <div
